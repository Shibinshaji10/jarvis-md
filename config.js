...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'ꜱʜɪʙɪɴ🧃;https://i.imgur.com/LCXfbma.jpeg',
  ...
  AUTHOR: process.env.AUTHOR || 'ꜱʜɪʙɪɴɴɴɴ🍭',
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ꜱʜɪʙɪɴ😚🧃;https://i.imgur.com/LCXfbma.jpeg',
  SUDO: process.env.SUDO || '917902375041,',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || 'ꜱʜɪʙɪɴ;😚🍭;https://i.imgur.com/LCXfbma.jpeg.',
